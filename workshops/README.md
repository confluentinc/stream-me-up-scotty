...
|---|---|
| [Datawarehouse Modernization](datawarehouse-modernization) | This workshop will provide a walkthrough experience of streaming change data from multiple databases into a single dataset that can be used to hydrate a cloud data warehouse. |
